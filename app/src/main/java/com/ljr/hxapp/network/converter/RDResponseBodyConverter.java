 ...
 */
package com.ljr.hxapp.network.converter;
...
import com.ljr.hxapp.network.exception.ApiException;
...
final class RDResponseBodyConverter<T> implements Converter<ResponseBody, T> {
    ...
    public T convert(ResponseBody value) throws IOException {
        ...
        try {
            ...
            int code = object.optInt(Params.RES_CODE);
            if (code != 0) {
                // 解析 resCode ,对不成功的返回做统一处理
                if (code != Params.RES_SUCCEED && code != Params.PWD_ERROR) {
